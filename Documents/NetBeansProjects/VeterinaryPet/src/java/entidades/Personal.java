...
public class Personal  implements java.io.Serializable {
    ...
    public Personal(int idPersonal, String nombre, String apellido, String dni, String telefono, String cargo, String email) {
    ...
    public Personal(int idPersonal, String nombre, String apellido, String dni, String telefono, String cargo, String email, Set usuarios, Set atencions) {
       this.idPersonal = idPersonal;
       this.nombre = nombre;
       this.apellido = apellido;
       this.dni = dni;
